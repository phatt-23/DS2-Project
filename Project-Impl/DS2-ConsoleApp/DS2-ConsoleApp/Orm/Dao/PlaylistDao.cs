...
namespace DS2ConsoleApp.Orm.Dao
{
    public static class PlaylistDao
    {
        ...
        {
            var playlistId = SqlAttribMapper.Get<Int64>(reader, "playlist_id");
            var userId = SqlAttribMapper.GetNullable<Int64>(reader, "user_id");
            var channelId = SqlAttribMapper.GetNullable<Int64>(reader, "channel_id");
